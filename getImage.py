...
img_dir = 'C:\\Users\\GOUTAM JAISWAL\\Desktop\\Final\\tmp_img\\nst'
...
for(x,y,w,h) in faces:
    img2=cv2.imread(content_path)[y:y+h,x:x+w]
    h1,w1=img2.shape[:2]
    x1=x
    y1=y
"""
 ...
 #     plot_img=plot_img.resize((w2,h2),Image.ANTIALIAS)
  #    img9=cv2.imread(content_path)
   #   plot_img[y1:y1+h2,x1:x1+w2]=img2
      ...
      #os.remove("tmp_img\\output\\test"+str(i)+".jpg")
      misc.imsave("tmp_img\\output\\test"+str(i)+".jpg",plot_img)
      #imageio.imwrite('picture_out.jpg',plot_img)
      #plot_img.savefig('output.png')
